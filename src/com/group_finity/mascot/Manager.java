...
public class Manager {
     ...
     */
    public static int TICK_INTERVAL = 35;

    public static boolean isMascotPopUpShowing = true;
    ...
    public void add(final Mascot mascot) {
        ...
        mascot.setPopUpShowing(isMascotPopUpShowing);
